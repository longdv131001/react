  ...
  return (
    <div>
        ...
        <div>
          <ul className="heroes">
            <li
              ...
              style={{
                backgroundColor:
                  selectedHero.id === value.id ? 'black' : 'gray',
              }}
            >
      ...
      <form autoComplete="off">
        ...
        <div>
          ...
          <input
            ...
            onChange={(evt) =>
              onChangeHandler(evt.target.value, selectedHero.id)
            }
          />
        </div>
      </form>
      <div>
        ...
        <button class="clear" onClick={historyHandleOnClick}>
          Clear messages
        </button>
        {historySelect.map((item) => (
          <div>
            <span key={item.id}>
              HeroesComponent: Selected hero id={item.id}
            </span>{' '}
          </div>
        ))}
      </div>
